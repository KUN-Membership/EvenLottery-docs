...
| `/lottery list [online/participants/winners/losers] [企画 ID または企画名]` | 企画の参加者一覧や当選者一覧を表示する   | ◯     |
...
#### 3.1.2. ケース：当選者以外をサーバに参加させる

デフォルトでは，当選者のみが企画のお部屋に入れるようになっています。
しかし，人数に余裕がある場合には，当選者以外の人も企画のお部屋に入れるようにできます。

その場合には，企画のお部屋に入って，`/lottery restroct` コマンドを実行してください。
これを実行すると，人数が満員でない限り，当選者以外の人も企画のお部屋に入れるようになります。
 

#### 3.1.3. ケース：当選者以外をサーバから強制退出する

企画を開始した直後には，まだ企画のお部屋に参加者以外の人が入っている可能性があります。
...
#### 3.1.4. ケース：企画の人数に合わせてサーバの最大人数を変更する
...
![3-1-3-lottery-event-fit.png](images/3-1-3-lottery-fit.png)
↑ `/lottery fit` コマンドのイメージ
...
`/lottery whitelist` コマンドは，ホワイトリストに登録されている人を優先的に参加させるかどうか，を切り替えるコマンドです。
...
#### 3.1.5. ケース：参加者の当落を確認する

企画を開始した後に，参加者の当落を確認したい場合があります。
その場合には，企画のお部屋に入って，企画の状態を確認するコマンド（`/lottery list online`）を実行してください。

そうすると，次のようなメッセージが表示されます。
![img.png](images/3-1-list-online.png)

このメッセージには，企画のお部屋に入っている参加者の一覧，および各参加者の当落情報が表示されます。
これは次のの３種類の色およびで表示されます：
